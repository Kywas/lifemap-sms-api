...
function createJob(row) {
  ...
  data.jobs.push({
    ...
    sender_phone: row.senderPhone ?? null,
...
function updateJob(id, patch) {
  ...
  if (patch.latitude !== undefined) job.latitude = patch.latitude;
  if (patch.longitude !== undefined) job.longitude = patch.longitude;
  if (patch.sender_phone !== undefined) job.sender_phone = patch.sender_phone;
  if (patch.sender_name !== undefined) job.sender_name = patch.sender_name;
